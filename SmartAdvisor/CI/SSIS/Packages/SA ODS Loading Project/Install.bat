...
ISDeploymentWizard.exe /Silent /ModelType:Project /SourcePath:"%buildpath_%\SA ODS Loading Project.ispac" /DestinationServer:"%1" /DestinationPath:"/SSISDB/%destinationfolder_%/SA ODS Loading Project"
