...
ISDeploymentWizard.exe /Silent /ModelType:Project /SourcePath:"%buildpath_%\WcsOds.ispac" /DestinationServer:"%1" /DestinationPath:"/SSISDB/%destinationfolder_%/WcsOds"
