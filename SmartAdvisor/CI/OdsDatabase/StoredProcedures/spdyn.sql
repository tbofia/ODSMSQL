IF OBJECT_ID('adm.Etl_ArchivePostingGroupAudit', 'P') IS NOT NULL
    DROP PROCEDURE adm.Etl_ArchivePostingGroupAudit
GO

CREATE PROCEDURE adm.Etl_ArchivePostingGroupAudit (
@CustomerId INT ,
