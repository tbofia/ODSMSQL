IF OBJECT_ID('adm.Rpt_CreateDatabaseSnapshot') IS NOT NULL
DROP PROCEDURE adm.Rpt_CreateDatabaseSnapshot
GO

CREATE PROCEDURE adm.Rpt_CreateDatabaseSnapshot(
@DBSnapshotName VARCHAR(255) OUTPUT,
@SnapshotServer VARCHAR(255) OUTPUT)
AS
BEGIN
--DECLARE @DBSnapshotName VARCHAR(255) ,@SnapshotServer VARCHAR(255)
...
-- Now let's create the snapshot
    ...
    BEGIN CATCH
        ...
        EXEC adm.Rpt_DropDatabaseSnapshot @DBSnapshotName;
