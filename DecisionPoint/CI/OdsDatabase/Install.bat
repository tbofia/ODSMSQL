...
ECHO Creating Partitions >> %outfile_%
sqlcmd -S %1 %unameparam_% %pwdparam_% -d %database_% -i partition.sql >> %outfile_%
...
REM ECHO Cleanup Old Objects db objects...
REM ECHO Cleanup Old Objects db objects... >> %outfile_%
