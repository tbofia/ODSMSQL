...
ECHO Creating new static views in existing dbs for reporting...
ECHO Creating new static views in existing dbs for reporting... >> %outfile_%
sqlcmd -S %1 %unameparam_% %pwdparam_% -d %database_% -i Update\PrepareOltpScripts\CreateViewsInExistingDbs.sql >> %outfile_%
