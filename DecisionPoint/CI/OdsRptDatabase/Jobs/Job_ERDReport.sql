...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'RPT: ERD Report', 
		@enabled=1, 
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'ERD Report Initialize Tables', 
		@step_id=1, 
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'ERD Report Output', 
		@step_id=2, 
		@cmdexec_success_code=0, 
		@retry_attempts=0, 
		@retry_interval=0, 
...
EXEC dbo.ERDReport_Output  @SourceDatabaseName, @StartDate, @EndDate, @if_Date, @RunType, @ReportID, @OdsCustomerID
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'ERD Report_CloseTrackingSendNotification', 
		@step_id=3, 
		@cmdexec_success_code=0, 
		@on_success_action=1, 
