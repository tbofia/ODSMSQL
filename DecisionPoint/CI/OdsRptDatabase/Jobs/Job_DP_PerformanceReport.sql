...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'RPT: DP Performance Report', 
		@enabled=1, 
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'DP_PerformnaceReport_Output_CleanUp', 
		@step_id=1, 
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'DP_PerformanceReport_ReportType1', 
		@step_id=2, 
		@cmdexec_success_code=0, 
		@retry_attempts=0, 
		@retry_interval=0, 
...
EXEC dbo.DP_PerformanceReport_Data @SourceDatabaseName,@StartDate,@EndDate, @if_Date,@RunType,@ReportId,@ReportType,@OdsCustomerId;
EXEC dbo.DP_PerformanceReport_SplitLines @OdsCustomerId;
EXEC dbo.DP_PerformanceReport_BenefitsExhausted @SourceDatabaseName,@if_Date,@RunType,@OdsCustomerId;
EXEC dbo.DP_PerformanceReport_MaxPrePPOBillInfo @SourceDatabaseName,@if_Date,@RunType,@OdsCustomerId;
EXEC dbo.DP_PerformanceReport_reductions_prevpn @SourceDatabaseName,@if_Date,@RunType,@OdsCustomerId;
EXEC dbo.DP_PerformanceReport_reductions_postvpn @SourceDatabaseName,@if_Date,@RunType,@OdsCustomerId;
EXEC dbo.DP_PerformanceReport_reductions_linelevelprioritized;
EXEC dbo.DP_PerformanceReport_reductions_rollup @SourceDatabaseName,@if_Date,@RunType,@ReportType,@OdsCustomerId
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'DP_PerformanceReport_ReportType2', 
		@step_id=3, 
		@cmdexec_success_code=0, 
		@retry_attempts=0, 
		@retry_interval=0, 
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'DP_PerformanceReport_ReportType3', 
		@step_id=4, 
		@cmdexec_success_code=0, 
		@retry_attempts=0, 
		@retry_interval=0, 
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'DP_PerformanceReport_Greenwich', 
		@step_id=5, 
		@cmdexec_success_code=0, 
		@retry_attempts=0, 
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'TSQL', 
		@command=N'EXEC dbo.DP_PerformanceReport_GreenwichData
', 
		@database_name=@DatabaseName, 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback

EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'DP_PerformanceReport_CloseTrackingSendNotification', 
		@step_id=6, 
		@cmdexec_success_code=0, 
		@on_success_action=1, 
