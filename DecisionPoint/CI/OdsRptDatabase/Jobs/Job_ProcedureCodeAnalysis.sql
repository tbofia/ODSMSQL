...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'RPT: ProcedureCode Analysis Report', 
		@enabled=1, 
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'ProcedureCodeAnalysis_Output_CleanUp', 
		@step_id=1, 
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'ProcedureCodeAnalysisReport_Client', 
		@step_id=2, 
		@cmdexec_success_code=0, 
		@retry_attempts=0, 
		@retry_interval=0, 
...
EXEC dbo.ProcedureCodeAnalysisReport_Client  @SourceDatabaseName = @SourceDatabaseName , @OdsCustomerID = @OdsCustomerId, @ReportId = @ReportId
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'ProcedureCodeAnalysisReport_Industry', 
		@step_id=3, 
		@cmdexec_success_code=0, 
		@retry_attempts=0, 
		@retry_interval=0, 
...
EXEC dbo.ProcedureCodeAnalysisReport_Industry  @SourceDatabaseName = @SourceDatabaseName , @OdsCustomerID = @OdsCustomerId, @ReportId = @ReportId
', 
		@database_name=@DatabaseName, 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback

EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'ProcedureCodeAnalysisReport_Output', 
		@step_id=4, 
		@cmdexec_success_code=0, 
		@retry_attempts=0, 
		@retry_interval=0, 
...
EXEC dbo.ProcedureCodeAnalysisReport_Output  @SourceDatabaseName = @SourceDatabaseName , @OdsCustomerID = @OdsCustomerId
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'ProcedureCodeAnalysis_GreenwichData', 
		@step_id=5, 
		@cmdexec_success_code=0, 
		@retry_attempts=0, 
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'TSQL', 
		@command=N'EXEC dbo.ProcedureCodeAnalysisReport_GreenwichData', 
		@database_name=@DatabaseName, 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback

EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'ProcedureCodeAnalysis_CloseTrackingSendNotification', 
		@step_id=6, 
		@cmdexec_success_code=0, 
		@on_success_action=1, 
